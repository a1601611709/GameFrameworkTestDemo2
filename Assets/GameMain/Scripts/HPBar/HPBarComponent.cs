...
namespace StarForceDemo
{
    public class HPBarComponent : GameFrameworkComponent
    {
        ...
        private void Start()
        {
            ...
            m_HPBarItemObjectPool = GameEntry.ObjectPool.CreateSingleSpawnObjectPool<HPBarItemObject>("HPBarItem", m_InstancePollCapacity);
        ...
        public void ShowHPBar(Entity entity, float fromHPRatio, float toHPRatio)
        {
            ...
            if (hpBarItem = null)
            {
                hpBarItem = GetActiveHPBarItem(entity);
